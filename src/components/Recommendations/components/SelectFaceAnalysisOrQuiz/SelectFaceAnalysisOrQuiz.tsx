...
const SelectFaceAnalysisOrQuiz = ({
  onClickQuiz,
  onClickFaceAnalysis,
}: SelectFaceAnalysisOrQuizProps) => {
  return (
    <div className="select-container">
      ...
      <button onClick={onClickQuiz} style={{marginTop: 56}}>Find skincare products</button>
      ...
      <button onClick={onClickFaceAnalysis}>Find haircare products</button>
      {/* <button onClick={onClickFaceAnalysis}>Start face analysis</button> */}
