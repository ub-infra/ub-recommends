...
import "./IdentifierOption.css";
export interface OptionProps {
  isSelected: boolean;
  label: string;
  onClick: (x: any) => void;
}
const IdentifierOption = ({ isSelected, label, onClick }: OptionProps) => {
  return (
    <div
      className="id-option"
      onClick={onClick}
      style={{ backgroundColor: isSelected ? "#E4E4E7" : "#FFF" }}
    >
      <div className="id-opt-wrap">
        {isSelected ? (
          <div>
            <svg
              width="20"
...
export default IdentifierOption;
